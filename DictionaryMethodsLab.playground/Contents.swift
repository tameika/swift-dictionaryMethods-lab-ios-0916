 ...
 */
var starWarsDroids = ["R2-D2", "C-3P0", "IG-88"]
...
var starWarsCharacters = ["Heros": starWarsHeroes,
 ...
 */
for characterTypes in starWarsCharacters.keys {
...
let removed = starWarsCharacters.removeValueForKey("Bounty Hunters")
